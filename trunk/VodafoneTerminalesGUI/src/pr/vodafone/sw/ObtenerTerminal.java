 ...
 */
            ...
            /**
            *  ObtenerTerminal bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class ObtenerTerminal
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":obtenerTerminal",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "obtenerTerminal",
    ...
    public static class Factory{
        ...
        */
        public static ObtenerTerminal parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            ObtenerTerminal object =
                new ObtenerTerminal();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"obtenerTerminal".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (ObtenerTerminal)java.sql.xsd.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
