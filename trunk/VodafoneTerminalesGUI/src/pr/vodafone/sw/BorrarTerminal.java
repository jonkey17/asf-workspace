 ...
 */
            ...
            /**
            *  BorrarTerminal bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class BorrarTerminal
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":borrarTerminal",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "borrarTerminal",
    ...
    public static class Factory{
        ...
        */
        public static BorrarTerminal parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            BorrarTerminal object =
                new BorrarTerminal();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"borrarTerminal".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (BorrarTerminal)java.sql.xsd.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
