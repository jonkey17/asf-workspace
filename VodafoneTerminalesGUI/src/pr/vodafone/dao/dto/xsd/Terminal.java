...
public class Terminal implements org.apache.axis2.databinding.ADBBean {
	/*
	 * This type was generated from the piece of schema that had name = Terminal
	 * Namespace URI = http://dto.dao.vodafone.pr/xsd Namespace Prefix = ns1
	 */
	...
	public void setPrecio(float param) {
		...
		localPrecioTracker = !java.lang.Float.isNaN(param);
	...
	public void setPromoBronce(float param) {
		...
		// setting primitive attribute tracker to true
		localPromoBronceTracker = !java.lang.Float.isNaN(param);
	...
	public void setPromoOro(float param) {
		...
		// setting primitive attribute tracker to true
		localPromoOroTracker = !java.lang.Float.isNaN(param);
	...
	public void setPromoPlata(float param) {
		...
		// setting primitive attribute tracker to true
		localPromoPlataTracker = !java.lang.Float.isNaN(param);
	...
	public void serialize(final javax.xml.namespace.QName parentQName,
		...
		if (serializeType) {
			...
			java.lang.String namespacePrefix = registerPrefix(xmlWriter,
					"http://dto.dao.vodafone.pr/xsd");
			if ((namespacePrefix != null)
					&& (namespacePrefix.trim().length() > 0)) {
				writeAttribute("xsi",
						"http://www.w3.org/2001/XMLSchema-instance", "type",
						namespacePrefix + ":Terminal", xmlWriter);
			} else {
				writeAttribute("xsi",
						"http://www.w3.org/2001/XMLSchema-instance", "type",
						"Terminal", xmlWriter);
		...
		if (localPrecioTracker) {
			...
			if (java.lang.Float.isNaN(localPrecio)) {
				...
				throw new org.apache.axis2.databinding.ADBException(
						"precio cannot be null!!");

			} else {
				xmlWriter
						.writeCharacters(org.apache.axis2.databinding.utils.ConverterUtil
								.convertToString(localPrecio));
			}
		...
		if (localPromoBronceTracker) {
			...
			if (java.lang.Float.isNaN(localPromoBronce)) {
				...
				throw new org.apache.axis2.databinding.ADBException(
						"promoBronce cannot be null!!");

			} else {
				xmlWriter
						.writeCharacters(org.apache.axis2.databinding.utils.ConverterUtil
								.convertToString(localPromoBronce));
			}
		...
		if (localPromoOroTracker) {
			...
			if (java.lang.Float.isNaN(localPromoOro)) {
				...
				throw new org.apache.axis2.databinding.ADBException(
						"promoOro cannot be null!!");

			} else {
				xmlWriter
						.writeCharacters(org.apache.axis2.databinding.utils.ConverterUtil
								.convertToString(localPromoOro));
			}
		...
		if (localPromoPlataTracker) {
			...
			if (java.lang.Float.isNaN(localPromoPlata)) {
				...
				throw new org.apache.axis2.databinding.ADBException(
						"promoPlata cannot be null!!");

			} else {
				xmlWriter
						.writeCharacters(org.apache.axis2.databinding.utils.ConverterUtil
								.convertToString(localPromoPlata));
			}
	...
	public javax.xml.stream.XMLStreamReader getPullParser(
		...
		if (localIdTerminalTracker) {
			elementList.add(new javax.xml.namespace.QName(
					"http://dto.dao.vodafone.pr/xsd", "idTerminal"));

			elementList.add(localIdTerminal == null ? null
					: org.apache.axis2.databinding.utils.ConverterUtil
							.convertToString(localIdTerminal));
		}
		if (localMarcaTracker) {
			elementList.add(new javax.xml.namespace.QName(
					"http://dto.dao.vodafone.pr/xsd", "marca"));

			elementList.add(localMarca == null ? null
					: org.apache.axis2.databinding.utils.ConverterUtil
							.convertToString(localMarca));
		}
		if (localModeloTracker) {
			elementList.add(new javax.xml.namespace.QName(
					"http://dto.dao.vodafone.pr/xsd", "modelo"));

			elementList.add(localModelo == null ? null
					: org.apache.axis2.databinding.utils.ConverterUtil
							.convertToString(localModelo));
		}
		if (localPrecioTracker) {
			elementList.add(new javax.xml.namespace.QName(
					"http://dto.dao.vodafone.pr/xsd", "precio"));
		...
		if (localPromoBronceTracker) {
			elementList.add(new javax.xml.namespace.QName(
					"http://dto.dao.vodafone.pr/xsd", "promoBronce"));
		...
		if (localPromoOroTracker) {
			elementList.add(new javax.xml.namespace.QName(
					"http://dto.dao.vodafone.pr/xsd", "promoOro"));
		...
		if (localPromoPlataTracker) {
			elementList.add(new javax.xml.namespace.QName(
					"http://dto.dao.vodafone.pr/xsd", "promoPlata"));
	...
	public static class Factory {
		 ...
		 * outer element
		 */
		public static Terminal parse(javax.xml.stream.XMLStreamReader reader)
			...
			try {
						...
						if (!"Terminal".equals(type)) {
							...
							java.lang.String nsUri = reader
									.getNamespaceContext().getNamespaceURI(
											nsPrefix);
							return (Terminal) java.sql.xsd.ExtensionMapper
				...
				if (reader.isStartElement()
					...
					if (!"true".equals(nillableValue)
						...
						object.setIdTerminal(org.apache.axis2.databinding.utils.ConverterUtil
				...
				if (reader.isStartElement()
					...
					if (!"true".equals(nillableValue)
						...
						object.setMarca(org.apache.axis2.databinding.utils.ConverterUtil
								.convertToString(content));
				...
				if (reader.isStartElement()
					...
					if (!"true".equals(nillableValue)
						...
						object.setModelo(org.apache.axis2.databinding.utils.ConverterUtil
								.convertToString(content));
				...
				if (reader.isStartElement()
					...
					object.setPrecio(org.apache.axis2.databinding.utils.ConverterUtil
				...
				if (reader.isStartElement()
					...
					if ("true".equals(nillableValue)
							|| "1".equals(nillableValue)) {
						throw new org.apache.axis2.databinding.ADBException(
								"The element: " + "promoBronce"
										+ "  cannot be null");
					}

					java.lang.String content = reader.getElementText();

					object.setPromoBronce(org.apache.axis2.databinding.utils.ConverterUtil
							.convertToFloat(content));
				...
				if (reader.isStartElement()
					...
					if ("true".equals(nillableValue)
							|| "1".equals(nillableValue)) {
						throw new org.apache.axis2.databinding.ADBException(
								"The element: " + "promoOro"
										+ "  cannot be null");
					}

					java.lang.String content = reader.getElementText();

					object.setPromoOro(org.apache.axis2.databinding.utils.ConverterUtil
							.convertToFloat(content));
				...
				if (reader.isStartElement()
					...
					if ("true".equals(nillableValue)
							|| "1".equals(nillableValue)) {
						throw new org.apache.axis2.databinding.ADBException(
								"The element: " + "promoPlata"
										+ "  cannot be null");
					}

					java.lang.String content = reader.getElementText();

					object.setPromoPlata(org.apache.axis2.databinding.utils.ConverterUtil
							.convertToFloat(content));
